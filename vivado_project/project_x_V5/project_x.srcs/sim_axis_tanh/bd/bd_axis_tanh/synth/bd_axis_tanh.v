...
//Command     : generate_target bd_axis_tanh.bd
//Design      : bd_axis_tanh
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_axis_tanh,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_axis_tanh,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "bd_axis_tanh.hwdef" *) 
module bd_axis_tanh
   (aclk_0,
    aresetn_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_RESET aresetn_0, CLK_DOMAIN bd_axis_tanh_aclk_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input aclk_0;
  ...
  bd_axis_tanh_axi4stream_vip_0_0 axi4stream_vip_0
       (.aclk(aclk_0_1),
        .aresetn(aresetn_0_1),
  ...
  bd_axis_tanh_axi4stream_vip_1_0 axi4stream_vip_1
       (.aclk(aclk_0_1),
        .aresetn(aresetn_0_1),
  ...
  bd_axis_tanh_axis_tanh_0_0 axis_tanh_0
       (.M_AXIS_TDATA(axis_tanh_0_M_AXIS_TDATA),
        ...
        .aclk(aclk_0_1),
        .aresetn(aresetn_0_1));
  bd_axis_tanh_floating_point_0_0 floating_point_0
       (.aclk(aclk_0_1),

...
import bd_dot_axi4stream_vip_0_0_pkg::*;
import bd_dot_axi4stream_vip_1_0_pkg::*;
...
module tb_dot();
    ...
    //master agent
    bd_dot_axi4stream_vip_0_0_mst_t  mst_agent;
    //slave agent
    bd_dot_axi4stream_vip_1_0_slv_t  slv_agent;
    ...
    task setup ();
        ...
        mst_agent = new("master vip agent",DUT.bd_dot_i.axi4stream_vip_0.inst.IF);
        slv_agent = new("slave vip agent",DUT.bd_dot_i.axi4stream_vip_1.inst.IF);

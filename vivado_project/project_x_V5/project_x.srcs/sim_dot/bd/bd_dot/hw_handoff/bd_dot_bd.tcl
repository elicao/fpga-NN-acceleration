...
################################################################
# This is a generated script based on design: bd_dot
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axis_dot_0_OUTPUT_AXIS [get_bd_intf_pins axi4stream_vip_1/S_AXIS] [get_bd_intf_pins axis_dot_0/OUTPUT_AXIS]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins axi4stream_vip_0/aclk] [get_bd_pins axi4stream_vip_1/aclk] [get_bd_pins axis_dot_0/aclk] [get_bd_pins floating_point_0/aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins axi4stream_vip_0/aresetn] [get_bd_pins axi4stream_vip_1/aresetn] [get_bd_pins axis_dot_0/aresetn]

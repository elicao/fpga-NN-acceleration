...
import bd_bias_layer_axi4stream_vip_0_0_pkg::*;
import bd_bias_layer_axi4stream_vip_0_1_pkg::*;

module tb_bias_layer();
    ...
    //master agent
    bd_bias_layer_axi4stream_vip_0_0_mst_t  mst_agent;
    //slave agent
    bd_bias_layer_axi4stream_vip_0_1_slv_t  slv_agent;
    ...
    task setup ();
        ...
        mst_agent = new("master vip agent",DUT.bd_bias_layer_i.axi4stream_vip_0.inst.IF);
        slv_agent = new("slave vip agent",DUT.bd_bias_layer_i.axi4stream_vip_1.inst.IF);

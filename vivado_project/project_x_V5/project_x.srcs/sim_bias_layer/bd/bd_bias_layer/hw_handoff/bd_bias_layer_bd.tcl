...
################################################################
# This is a generated script based on design: bd_bias_layer
#
...
# source bd_bias_layer_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins axi4stream_vip_0/aclk] [get_bd_pins axi4stream_vip_1/aclk] [get_bd_pins axis_bias_0/aclk] [get_bd_pins axis_dot_0/aclk] [get_bd_pins axis_tanh_0/aclk] [get_bd_pins floating_point_0/aclk] [get_bd_pins floating_point_1/aclk] [get_bd_pins floating_point_2/aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins axi4stream_vip_0/aresetn] [get_bd_pins axi4stream_vip_1/aresetn] [get_bd_pins axis_bias_0/aresetn] [get_bd_pins axis_dot_0/aresetn] [get_bd_pins axis_tanh_0/aresetn]

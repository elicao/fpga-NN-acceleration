...
//Date        : Tue Apr 28 03:15:27 2020
//Host        : ubuntu running 64-bit Ubuntu 18.04.3 LTS
//Command     : generate_target bd_bias_layer.bd
//Design      : bd_bias_layer
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_bias_layer,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_bias_layer,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=4,synth_mode=Global}" *) (* HW_HANDOFF = "bd_bias_layer.hwdef" *) 
module bd_bias_layer
   (aclk_0,
    aresetn_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_RESET aresetn_0, CLK_DOMAIN bd_bias_layer_aclk_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input aclk_0;
  ...
  bd_bias_layer_axi4stream_vip_0_0 axi4stream_vip_0
       (.aclk(aclk_0_1),
        .aresetn(aresetn_0_1),
  ...
  bd_bias_layer_axi4stream_vip_0_1 axi4stream_vip_1
       (.aclk(aclk_0_1),
        .aresetn(aresetn_0_1),
  ...
  bd_bias_layer_axis_dot_0_0 axis_dot_0
       (.FPU_IN_AXIS_TDATA(floating_point_0_M_AXIS_RESULT_TDATA),
        ...
        .aclk(aclk_0_1),
        .aresetn(aresetn_0_1));
  bd_bias_layer_axis_tanh_0_0 axis_tanh_0
       (.M_AXIS_TDATA(axis_tanh_0_M_AXIS_TDATA),
        ...
        .aclk(aclk_0_1),
        .aresetn(aresetn_0_1));
  bd_bias_layer_floating_point_0_0 floating_point_0
       (.aclk(aclk_0_1),
  ...
  bd_bias_layer_floating_point_0_1 floating_point_1
       (.aclk(aclk_0_1),
  ...
  bd_bias_layer_floating_point_1_0 floating_point_2
       (.aclk(aclk_0_1),

...
################################################################
# This is a generated script based on design: bd_fpga_test
#
...
# source bd_fpga_test_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# axis_bias, axis_dot, axis_tanh
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_bias_0, and set properties
  set block_name axis_bias
  set block_cell_name axis_bias_0
  if { [catch {set axis_bias_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_bias_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_dot_0/INPUT_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axis_dot_0/INPUT_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axis_bias_0_M_AXIS [get_bd_intf_pins axis_bias_0/M_AXIS] [get_bd_intf_pins floating_point_1/S_AXIS_B]
  ...
  connect_bd_intf_net -intf_net axis_tanh_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_tanh_0/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_tanh_0_M_AXIS] [get_bd_intf_pins axis_tanh_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_tanh_0_M_AXIS]
  ...
  connect_bd_intf_net -intf_net floating_point_2_M_AXIS_RESULT [get_bd_intf_pins axis_tanh_0/S_AXIS] [get_bd_intf_pins floating_point_2/M_AXIS_RESULT]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axis_bias_0/aclk] [get_bd_pins axis_dot_0/aclk] [get_bd_pins axis_tanh_0/aclk] [get_bd_pins floating_point_0/aclk] [get_bd_pins floating_point_1/aclk] [get_bd_pins floating_point_2/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_bias_0/aresetn] [get_bd_pins axis_dot_0/aresetn] [get_bd_pins axis_tanh_0/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins system_ila_0/resetn]

...
HD_PWD='/home/lukefahr/e315/project_x/project_x.runs/bd_fpga_test_smartconnect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_fpga_test_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_fpga_test_smartconnect_0_0.tcl

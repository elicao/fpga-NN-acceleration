...
HD_PWD='C:/Users/Tyler/Documents/GitHub/E315_Final/vivado_project/project_x_V5/project_x.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_fpga_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_fpga_wrapper.tcl -notrace

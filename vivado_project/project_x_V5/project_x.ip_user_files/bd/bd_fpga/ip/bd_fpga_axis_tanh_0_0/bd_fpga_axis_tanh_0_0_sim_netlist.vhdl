...
-- Date        : Tue Apr 21 12:49:49 2020
-- Host        : ubuntu running 64-bit Ubuntu 18.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/lukefahr/e315/project_x/project_x.srcs/sources_1/bd/bd_fpga/ip/bd_fpga_axis_tanh_0_0/bd_fpga_axis_tanh_0_0_sim_netlist.vhdl
-- Design      : bd_fpga_axis_tanh_0_0
...
entity bd_fpga_axis_tanh_0_0_tanh_lut is
  port (
    M_AXIS_TDATA : out STD_LOGIC_VECTOR ( 26 downto 0 );
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 21 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bd_fpga_axis_tanh_0_0_tanh_lut : entity is "tanh_lut";
end bd_fpga_axis_tanh_0_0_tanh_lut;

architecture STRUCTURE of bd_fpga_axis_tanh_0_0_tanh_lut is
  ...
  signal \scaled_x_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \scaled_x_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \scaled_x_carry__0_i_3_n_0\ : STD_LOGIC;
  ...
  signal \scaled_x_carry__2_n_0\ : STD_LOGIC;
  ...
  signal \scaled_x_carry__3_n_0\ : STD_LOGIC;
  signal \scaled_x_carry__3_n_1\ : STD_LOGIC;
  signal \scaled_x_carry__3_n_2\ : STD_LOGIC;
  signal \scaled_x_carry__3_n_3\ : STD_LOGIC;
  signal \scaled_x_carry__3_n_4\ : STD_LOGIC;
  signal \scaled_x_carry__3_n_5\ : STD_LOGIC;
  signal \scaled_x_carry__3_n_6\ : STD_LOGIC;
  signal \scaled_x_carry__3_n_7\ : STD_LOGIC;
  signal \scaled_x_carry__4_n_3\ : STD_LOGIC;
  signal \scaled_x_carry__4_n_6\ : STD_LOGIC;
  signal \scaled_x_carry__4_n_7\ : STD_LOGIC;
  signal scaled_x_carry_i_1_n_0 : STD_LOGIC;
  signal scaled_x_carry_i_2_n_0 : STD_LOGIC;
  signal scaled_x_carry_i_3_n_0 : STD_LOGIC;
  ...
  signal NLW_scaled_x_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \NLW_scaled_x_carry__4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_scaled_x_carry__4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
begin
...
\M_AXIS_TDATA[31]_INST_0_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \scaled_x_carry__2_n_7\,
      I3 => \scaled_x_carry__1_n_6\,
      I4 => \scaled_x_carry__1_n_5\,
...
\M_AXIS_TDATA[31]_INST_0_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \scaled_x_carry__3_n_5\,
      I1 => \scaled_x_carry__3_n_6\,
      I2 => \scaled_x_carry__4_n_7\,
      I3 => \scaled_x_carry__3_n_4\,
...
\M_AXIS_TDATA[31]_INST_0_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \scaled_x_carry__2_n_5\,
      I1 => \scaled_x_carry__2_n_6\,
      I2 => \scaled_x_carry__3_n_7\,
      I3 => \scaled_x_carry__2_n_4\,
...
scaled_x_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => S_AXIS_TDATA(3 downto 1),
      DI(0) => '0',
      O(3 downto 2) => sel(1 downto 0),
      O(1 downto 0) => NLW_scaled_x_carry_O_UNCONNECTED(1 downto 0),
      S(3) => scaled_x_carry_i_1_n_0,
      S(2) => scaled_x_carry_i_2_n_0,
      S(1) => scaled_x_carry_i_3_n_0,
      S(0) => S_AXIS_TDATA(0)
    );
\scaled_x_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => S_AXIS_TDATA(6 downto 4),
      O(3 downto 0) => sel(5 downto 2),
      S(3) => S_AXIS_TDATA(7),
      S(2) => \scaled_x_carry__0_i_1_n_0\,
      S(1) => \scaled_x_carry__0_i_2_n_0\,
      S(0) => \scaled_x_carry__0_i_3_n_0\
    );
\scaled_x_carry__0_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => S_AXIS_TDATA(6),
      O => \scaled_x_carry__0_i_1_n_0\
    );
\scaled_x_carry__0_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => S_AXIS_TDATA(5),
      O => \scaled_x_carry__0_i_2_n_0\
    );
\scaled_x_carry__0_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => S_AXIS_TDATA(4),
      O => \scaled_x_carry__0_i_3_n_0\
    );
...
\scaled_x_carry__3\: unisim.vcomponents.CARRY4
     port map (
      CI => \scaled_x_carry__2_n_0\,
      CO(3) => \scaled_x_carry__3_n_0\,
      CO(2) => \scaled_x_carry__3_n_1\,
      CO(1) => \scaled_x_carry__3_n_2\,
      CO(0) => \scaled_x_carry__3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \scaled_x_carry__3_n_4\,
      O(2) => \scaled_x_carry__3_n_5\,
      O(1) => \scaled_x_carry__3_n_6\,
      O(0) => \scaled_x_carry__3_n_7\,
      S(3 downto 0) => S_AXIS_TDATA(19 downto 16)
    );
\scaled_x_carry__4\: unisim.vcomponents.CARRY4
     port map (
      CI => \scaled_x_carry__3_n_0\,
      CO(3 downto 1) => \NLW_scaled_x_carry__4_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \scaled_x_carry__4_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_scaled_x_carry__4_O_UNCONNECTED\(3 downto 2),
      O(1) => \scaled_x_carry__4_n_6\,
      O(0) => \scaled_x_carry__4_n_7\,
      S(3 downto 2) => B"00",
      S(1 downto 0) => S_AXIS_TDATA(21 downto 20)
    );
...
scaled_x_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => S_AXIS_TDATA(2),
      O => scaled_x_carry_i_2_n_0
    );
scaled_x_carry_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => S_AXIS_TDATA(1),
      O => scaled_x_carry_i_3_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_fpga_axis_tanh_0_0_axis_tanh is
  port (
    M_AXIS_TDATA : out STD_LOGIC_VECTOR ( 26 downto 0 );
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 21 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bd_fpga_axis_tanh_0_0_axis_tanh : entity is "axis_tanh";
end bd_fpga_axis_tanh_0_0_axis_tanh;

architecture STRUCTURE of bd_fpga_axis_tanh_0_0_axis_tanh is
begin
tanh: entity work.bd_fpga_axis_tanh_0_0_tanh_lut
     port map (
      M_AXIS_TDATA(26 downto 0) => M_AXIS_TDATA(26 downto 0),
      S_AXIS_TDATA(21 downto 0) => S_AXIS_TDATA(21 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_fpga_axis_tanh_0_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of bd_fpga_axis_tanh_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_fpga_axis_tanh_0_0 : entity is "bd_fpga_axis_tanh_0_0,axis_tanh,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of bd_fpga_axis_tanh_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of bd_fpga_axis_tanh_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of bd_fpga_axis_tanh_0_0 : entity is "axis_tanh,Vivado 2018.3";
end bd_fpga_axis_tanh_0_0;

architecture STRUCTURE of bd_fpga_axis_tanh_0_0 is
...
inst: entity work.bd_fpga_axis_tanh_0_0_axis_tanh
     port map (
      M_AXIS_TDATA(26) => \^m_axis_tdata\(31),
      M_AXIS_TDATA(25 downto 0) => \^m_axis_tdata\(25 downto 0),
      S_AXIS_TDATA(21 downto 0) => S_AXIS_TDATA(31 downto 10)
    );
end STRUCTURE;

...
xvlog_opts="--relax -L axi4stream_vip_v1_1_4 -L xilinx_vip"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axis_infrastructure_v1_1_0 -L xil_defaultlib -L axi4stream_vip_v1_1_4 -L xbip_utils_v3_0_9 -L axi_utils_v2_0_5 -L xbip_pipe_v3_0_5 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_5 -L xbip_dsp48_multadd_v3_0_5 -L xbip_bram18k_v3_0_5 -L mult_gen_v12_0_14 -L floating_point_v7_1_7 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bd_axis_tanh xil_defaultlib.bd_axis_tanh xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bd_axis_tanh -key {Behavioral:sim_axis_tanh:Functional:bd_axis_tanh} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_LUTmoid.protoinst" -protoinst "protoinst_files/bd_axis_tanh.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bd_axis_tanh.wdb xsim.dir)
